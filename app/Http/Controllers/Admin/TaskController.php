...
class TaskController extends Controller
{
    ...
    public function index()
    {
        ...
        $tasks = Task::with(['status', 'tags', 'assigned_to', 'vehicle', 'properties', 'contract', 'team', 'media'])->get();
        ...
        return view('admin.tasks.index', compact('contracts', 'properties', 'task_statuses', 'task_tags', 'tasks', 'teams', 'users', 'vehicles'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.tasks.create', compact('assigned_tos', 'contracts', 'properties', 'statuses', 'tags', 'vehicles'));
    }
    ...
    public function edit(Task $task)
    {
        ...
        $task->load('status', 'tags', 'assigned_to', 'vehicle', 'properties', 'contract', 'team');

        return view('admin.tasks.edit', compact('assigned_tos', 'contracts', 'properties', 'statuses', 'tags', 'task', 'vehicles'));
    }

...
class TaskApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new TaskResource(Task::with(['status', 'tags', 'assigned_to', 'vehicle', 'properties', 'contract', 'team'])->get());
    }
    ...
    public function show(Task $task)
    {
        ...
        return new TaskResource($task->load(['status', 'tags', 'assigned_to', 'vehicle', 'properties', 'contract', 'team']));
    }

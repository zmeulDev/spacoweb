...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#user_vehicles" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" role="tabpanel" id="user_vehicles">
            @includeIf('admin.users.relationships.userVehicles', ['vehicles' => $user->userVehicles])
        </div>
    </div>
</div>

    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-propertyContracts">
                    <thead>
                        <tr>
                            <th width="10">
...
@endcan
  ...
  let table = $('.datatable-propertyContracts:not(.ajaxTable)').DataTable({ buttons: dtButtons })

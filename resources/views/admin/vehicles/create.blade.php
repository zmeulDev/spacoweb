    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.vehicles.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vin') ? 'is-invalid' : '' }}" type="text" name="vin" id="vin" value="{{ old('vin', '') }}">
                @if($errors->has('vin'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('odometer') ? 'is-invalid' : '' }}" type="number" name="odometer" id="odometer" value="{{ old('odometer', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('manufacter_date') ? 'is-invalid' : '' }}" type="text" name="manufacter_date" id="manufacter_date" value="{{ old('manufacter_date') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('owner') ? 'is-invalid' : '' }}" name="owner" id="owner">
                    ...
                    @foreach(App\Models\Vehicle::OWNER_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('owner', 'Select') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('owner'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('insurance') ? 'is-invalid' : '' }}" type="text" name="insurance" id="insurance" value="{{ old('insurance') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('inspection') ? 'is-invalid' : '' }}" type="text" name="inspection" id="inspection" value="{{ old('inspection') }}">
